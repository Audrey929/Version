package com.audrey.versionupdate2;
...
import com.audrey.versionupdate2.presenter.UpdatePresenter;
...
public class MainActivity extends AppCompatActivity implements UpdateView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updatePresenter.getAddressRecycleGson(""+(++getVersionCode));

    }


    /**
     * implements UpdateView重写的方法
     * @param updateBean
     */
    @Override
    public void update(UpdateBean updateBean) {
        if (updateBean.getCode().equals("0")){
            Log.e("TAG", updateBean.getData().getApkUrl());
            ApkUrl = updateBean.getData().getApkUrl();
